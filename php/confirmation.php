...
// Récupérer les paramètres de retour du système de paiement avec les noms corrects
$transaction_id = isset($_GET['transaction']) ? htmlspecialchars($_GET['transaction']) : '';
// Changement de "result" à "status" pour correspondre au retour de l'API
$result = isset($_GET['status']) ? htmlspecialchars($_GET['status']) : '';
// Changement pour les autres paramètres selon le format de retour
...
// Vérification du statut pour validation du paiement
$payment_validated = ($result === 'accepted');

// Récupérer les données de la réservation en session
...
// Récupérer les informations de réduction si présentes
$promo_code = $_SESSION['promo_code'] ?? '';
$reduction = $_SESSION['promo_reduction'] ?? 0;

// Si le paiement est validé, enregistrer la réservation
...
<head>
    ...
    <title><?php echo $payment_validated ? 'Confirmation de réservation' : 'Échec du paiement'; ?> • Marvel Travel</title>
            ...
            <div class="confirmation-card error-card">
                ...
                <div class="card-content">
                    <p class="error-message">
                        Votre transaction a été refusée par le système de paiement. Cela peut être dû à plusieurs raisons :
                    </p>
                    ...
                    <p>Aucun montant n'a été débité de votre compte. Vous pouvez réessayer le paiement ou utiliser une autre méthode de paiement.</p>
                </div>
            </div>
                    ...
                    <ul class="tips-list">
                        <li>
                            ...
                            <div class="tip-content">
                                ...
                                <p>Assurez-vous que le numéro de carte, la date d'expiration et le code de sécurité sont correctement saisis.</p>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="tip-content">
                                ...
                                <p>Effectuez votre paiement sur un réseau sécurisé et évitez les réseaux Wi-Fi publics.</p>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="tip-content">
                                ...
                                <p>Si le problème persiste, votre banque pourrait avoir bloqué la transaction par mesure de sécurité.</p>
                            </div>
                        </li>
                    </ul>
                </div>
